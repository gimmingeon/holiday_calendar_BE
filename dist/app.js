...
const mate_router_1 = __importDefault(require("./mate/mate.router"));
const memberCondition_router_1 = __importDefault(require("./memberCondition/memberCondition.router"));
data_sourse_1.AppDataSourse.initialize()
    ...
    app.use('/mate', jwt_validate_middleware_1.jwtMiddleware, mate_router_1.default);
    app.use('/condition', jwt_validate_middleware_1.jwtMiddleware, memberCondition_router_1.default);
    const port = 3000;
    app.listen(port, () => {
